...
const highlightItems = [
  {
    ...
    image: '/tes 2.png',
    summary:
      'A miniaturized flexible bioelectronic interface designed for seamless integration with wearable electrochemical biosensors.
The flexible PCB architecture integrates biosensors, signal conditioning circuits, and wireless communication modules, enabling stable signal acquisition and low-noise electrochemical impedance measurements for real-time physiological monitoring. This platform provides a scalable hardware interface for portable and wearable biochemical sensing systems.',
    paper_title:
  ...
  },
  {
    ...
    image: '/POCT.png',
    summary:
      'A portable point-of-care biosensing system for rapid detection of salivary biomarkers.
...
The wrinkled nanoporous architecture introduces dense micro- and nanoscale features that generate abundant electromagnetic “hot spots,” significantly enhancing surface-enhanced Raman scattering (SERS) signals. This scalable nanostructured metal platform enables ultrasensitive molecular detection for chemical and biological sensing applications.',
    ...
    image: '/go w.png',
    summary:
      'A wrinkled graphene nanostructure engineered for high-surface-area electronic and sensing applications.
The crumpled graphene morphology introduces abundant nanoscale edges and defects that enhance charge transfer and molecular interaction at the surface. This hierarchical graphene architecture provides an effective platform for high-sensitivity chemical and biological sensing devices.',
    paper_title:
    ...
    image: '/MICRO.png',
    summary:
      'A microstructured dome array engineered to enhance optical and interfacial interactions at the microscale.
The highly ordered hemispherical architecture enables precise control of light propagation and surface interactions, providing improved performance for optical sensing and microdevice integration. Such three-dimensional microstructured platforms offer scalable design strategies for advanced sensing and optoelectronic systems.',
    paper_title:
      'A Wearable Electrochemical Biosensor for Salivary Detection of Periodontal Inflammation Biomarkers: Molecularly Imprinted Polymer Sensor with Deep Learning Integration',
    ...
    image: '/SE.png',
    summary:
      'A scalable fabrication strategy for patterned thin-film arrays of selenium nanowires enabling nonlinear photonic devices.
Micron-scale pixel architectures are created through controlled nanowire deposition on patterned substrates, forming ordered nanowire arrays for efficient optical interaction. The resulting structures support strong second-harmonic generation (SHG), enabling wavelength conversion and full-color laser display technologies.',
    paper_title:
